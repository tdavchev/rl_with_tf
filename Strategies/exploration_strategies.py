...
class Q_Network():
    def __init__(self):
        # These lines establish the feed-forward part of the nework used to choose actions
        ...
        # Below we obtain the loss by taking the sum of squared differences between
...
# bayesian Percent of succesful episodes: 153.73765%
# bayesian Percent of succesful episodes: 76.95505%
# bayesian Percent of succesful episodes: 72.60945%
# boltzmann Percent of succesful episodes: 11.3459%
# boltzmann Percent of succesful episodes: 31.6565%
# boltzmann Percent of succesful episodes: 10.74865%
# e-greedy Percent of succesful episodes: 91.41345%
# greedy Percent of succesful episodes: 9.3763%
# random Percent of succesful episodes: 22.447%
exploration = "boltzmann" # Exploration method.
