...
from custom_lib.envs.cliff_walking import CliffWalkingEnv
from custom_lib import plotting
...
def actor_critic(env, estimator_policy, estimator_value, num_episodes, discount_factor=1.0):
    ...
    Transition = collections.namedtuple("Trainsition", ["state", "action", "reward", "next_state", "done"])
